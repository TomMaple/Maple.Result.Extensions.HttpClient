...
// This is a copy of the <c>ProblemDetails</c> class defined in the <c>Microsoft.AspNetCore.Mvc</c> namespace,
// so the <i>ASP.NET Core</i> framework is not required to be referenced in order to use this class.
...
/// </summary>
internal class ProblemDetailsInternal
{
    /// <summary>
